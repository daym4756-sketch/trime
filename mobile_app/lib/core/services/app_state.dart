    ...
    if (_barbershops.isEmpty) {
      _barbershops.addAll([
        const BarbershopProfile(
          ...
          coverUrl: 'https://images.unsplash.com/photo-1585747860715-2ba37e788b70?w=600&h=450&fit=crop&auto=format',
          rating: 4.9,
          latitude: -6.2088,
          longitude: 106.8456,
          isNew: false,
        ...
        const BarbershopProfile(
          ...
          coverUrl: 'https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=600&h=450&fit=crop&auto=format',
          rating: 4.8,
          latitude: -6.2297,
          longitude: 106.8167,
          isNew: true,
        ...
        const BarbershopProfile(
          ...
          coverUrl: 'https://images.unsplash.com/photo-1560066984-138dadb4c035?w=600&h=450&fit=crop&auto=format',
          rating: 4.7,
          latitude: -6.2345,
          longitude: 106.8090,
          isNew: false,
